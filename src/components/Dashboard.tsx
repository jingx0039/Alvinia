    ...
    <div className="flex h-screen bg-zinc-50 text-zinc-900 overflow-hidden font-sans">
      ...
      <main className="flex-grow h-full overflow-y-auto flex flex-col justify-between">
        ...
        <div className="p-8 flex-grow">
          {errorString ? (
            /* RED ERROR ALERT WITH RETRY BUTTON & ENHANCED ATLAS WIZARD - Direct User Request */
            <div className="w-full max-w-2xl mx-auto my-6 space-y-6">
              ...
              {/* INTEGRATION ASSISTANT & TROUBLESHOOTING GUIDE */}
                ...
                {showAtlasGuide && (
                  <div className="p-6 space-y-5 animate-fadeIn">
                    ...
                    <div className="p-4 bg-zinc-50 border border-zinc-200 rounded-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                      <div>
                        <h6 className="text-xs font-bold text-zinc-800">Quick-Copy Whwhitelist Address Range</h6>
                      ...
                      <div className="flex items-center gap-2 w-full sm:w-auto self-stretch sm:self-auto shrink-0 justify-end">
                        ...
                        <button
                          onClick={() => {
                            ...
                            // Re-use current system copied banner state temporarily to visual feedback
                    ...
                    <div className="pt-2 border-t border-zinc-100 flex flex-col sm:flex-row items-center justify-between gap-3 text-zinc-500 text-[10px]">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span>Ready to auto-reconnect once the IP access rules are propagated.</span>
                      </div>
